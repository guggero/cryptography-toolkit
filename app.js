...
function routeConfig($locationProvider, $routeProvider) {
  ...
  $routeProvider
    ...
    .when('/hashing', {template: '<hashing-page></hashing-page>', containerClass: 'container'})
    ...
    .when('/xpub-editor', {template: '<xpub-editor-page></xpub-editor-page>', containerClass: 'container'})
    .when('/xpub-xpriv-editor', {template: '<xpub-editor-page></xpub-editor-page>', containerClass: 'container'})
